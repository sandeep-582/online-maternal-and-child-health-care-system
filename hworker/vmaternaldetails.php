...
<html lang="en">
<head>
	<title>View Maternal Details</title>
  <meta charset="UTF-8">
...
<body>
<center><h1>View Maternal Details</h1>
  <ul class="breadcrumb">
  <li><a href="../home/homepage.php">Home</a></li>
  <li><a href="../login/hwlogin.php">Login</a></li>
  <li><a href="hwfeatures.php">Health worker Page</a></li>
   <li>View Maternal Details</li>
  </ul><br><br><br><br><br>
<form  action="vmaternaldetails.php" method="POST">
   <div class="bg-text">
    <table>
        <tr>
  ...
  if (isset($_POST['search'])) 
   {
      ...
      $query="SELECT * FROM `mdetails` WHERE Area='$Area'";
    ...
    if (empty($Area)) {
     ...
     {
      $_SESSION['Area']=$Area;
      header("refresh:0;url=maternaldetails.php"); 
      }
      else{
